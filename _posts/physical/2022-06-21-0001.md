...
---
<!-- wp:paragraph -->
<p>This is an archive page for a <strong>physical</strong> artifact: <em><code>{{page.title}}.</code></em></p>
<!-- /wp:paragraph -->
<table>
    <tr>
        <td><b>TITLE</b>:</td>
    ...
    <tr>
        ...
        <td>Artifact complete [<code>CPLT</code>]</td>
    </tr>
    <tr>
        <td><b>SUBMITTER:</b></td>
        <td><a   href="//members.yeahgames.net/@{{post.submitter}}"><img   src="https://cdn.yeahgames.net/img/members/profile/default/@{{post.submitter}}.png"   height="16"   width="16"> @{{post.submitter}}</a></td>
    </tr>
    <tr>
        <td><b>ARCHIVIST:</b></td>
