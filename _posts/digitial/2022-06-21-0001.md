...
---
 <p>This is an archive page for a <strong>{% if page.serial contains "p" or "P" %}physical{% endif %}{% if page.serial contains "d" or "D" %}digital{% endif %}</strong> artifact: <em><code>{{page.title}}</code></em>.</p><table>
    <tr>
        <td><b>TITLE</b>:</td>
        <td>{{page.title}}</td>
    </tr>
    <tr>
         ...
         <td>{% if page.description %}"{{page.description}}"{% unless page.description == empty %}No description provided.{% endunless %}{% endif %}</td>
    </tr>
    <tr>
        <td><b>SERIAL ID:</b></td>
        <td>{{page.serial}}</td>
